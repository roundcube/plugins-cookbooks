commands=["packagist:update --no-debug --env=prod", "packagist:dump --no-debug --env=prod", "packagist:index --no-debug --env=prod", "packagist:stats:compile --no-debug --env=prod"]
